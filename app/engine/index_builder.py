...
class IndexBuilder:
    ...
    def build(
    ...
    ) -> tuple[dict[str, TermEntry], CorpusStats]:
        ...
        term_postings: dict[str, dict[int, dict[str, int]]] = defaultdict(
        ...
        for term, doc_ids in term_doc_sets.items():
            ...
            index[term] = TermEntry(doc_freq=len(doc_ids), postings=postings_dict)
