...
def test_db():
    ...
    with Session(engine) as session:
        ...
        # Products
        p1 = Product(id=1, name="Sony TV", price=50000.0, category_id=cat_e.id, is_active=True, brand="Sony", description="Smart TV")
        p2 = Product(id=2, name="Nike Shirt", price=1500.0, category_id=cat_c.id, is_active=True, brand="Nike", description="Running Shirt")
        p3 = Product(id=3, name="Cheap TV", price=10000.0, category_id=cat_e.id, is_active=True, brand="Generic", description="Small TV")
        p4 = Product(id=4, name="Old Phone", price=5000.0, category_id=cat_e.id, is_active=False, brand="Sony", description="Inactive phone") # Inactive
