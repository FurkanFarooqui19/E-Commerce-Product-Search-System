...
def upgrade() -> None:
    ...
    op.create_index('idx_products_active_price', 'products', ['is_active', 'price'], unique=False)
    ...
    op.create_index('idx_specs_key', 'product_specifications', ['spec_key'], unique=False)
    ...
    sa.ForeignKeyConstraint(['product_id'], ['products.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['query_id'], ['evaluation_queries.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('query_id', 'product_id', name='uq_judgment_query_product')
    )
    op.create_index('idx_judgments_product_id', 'relevance_judgments', ['product_id'], unique=False)
    op.create_index('idx_judgments_query_id', 'relevance_judgments', ['query_id'], unique=False)
